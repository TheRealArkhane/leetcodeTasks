...
public class RemoveDuplicatesFromSortedArray {
    public static void main(String[] args) {
        System.out.println(removeDuplicates(new int[]{1,1,2,2,3,4,5,6,6,7,7,7,8,9,10}));
        System.out.println(removeDuplicatesInPlace(new int[]{1,1,2,2,3,4,5,6,6,7,7,7,8,9,10}));
    }
